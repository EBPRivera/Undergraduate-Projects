function SOR(A, B, TOL, N, w)
    %Algorithm taken from lecture slides
    ...
    while k <= N
        ...
        for i = 1:n
            ...
            summation_2 = 0;
            for j = 1:i-1
                summation_1 = summation_1 + A(i,j)*x(1,j);
            end
            for j = 1+1:n
                summation_2 = summation_2 + A(i,j)*X0(1,j);
            end
            x(1,i) = (1-w)*X0(1,i) + (1/A(i,i))*w*(-summation_1-summation_2 + B(1,i));
        end
